...
class ProdukController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        if($new_cover){
        if($produks->cover && file_exists(storage_path('app/public/' . $produks->cover))){
        \Storage::delete('public/'. $produks->cover);
    }

        $new_cover_path = $new_cover->store('produk-covers', 'public');

        $produks->cover = $new_cover_path;
    }
