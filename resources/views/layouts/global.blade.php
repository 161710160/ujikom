...
<body>
	...
	<script src="{{ asset('/assets/dist/sweet.min.js')}}"></script>
		@include('sweet::alert')
	...
	<input class="border-dark bg-primary-darkest form-control d-none d-md-block w-50 ml-3 mr-2" type="		 text" placeholder="Cari" aria-label="Cari">
...
@endif
	...
	<li>
		...
		<li><a href="/home"><span class="oi oi-home"></span> Home</a>
			...
			Kategori</a></li>
			<li><a href="{{route('carts.index')}}"><span class="fa fa-shopping-cart"></span>
			Cart</a></li>
			<i class="" aria-hidden="true"></i>
		<li>
			<li><a href="{{route('checkouts.index')}}"><span class="oi oi-book"></span>
			Checkout</a></li>
		<li>
		<li><a href="{{route('kategoriartikel.index')}}"><span class="oi oi-tag"></span>
			KategoriArtikel</a></li>
		<li>
		<li><a href="{{route('artikel.index')}}"><span class="fa fa-newspaper-o"></span>
			Artikel</a></li>
		<li>
	...
	<button class="dropdown-item"style="cursor:pointer">Sign Out</button>
		...
		<script
			...
			uefMccjFJAIv6A+rW+L4AHf99KvxDjWSu1z9VI8SKNVmz4sk7buKt/6v9KI65qnm"crossorigin="anonymous">
		</script>
