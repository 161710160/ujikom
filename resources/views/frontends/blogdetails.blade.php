...
<!-- Mirrored from demo.devitems.com/uniqlo//blogdetails by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 28 Nov 2018 04:40:40 GMT -->
<head>
    <meta charset="utf-8">
                            ...
                            <div class="blog-details-top">
                                ...
                                <div class="blog-details-thumb-wrap">
                                    ...
                                    <div class="blog-details-thumb">
                                        <img src="{{ asset ('assets/img/artikel/' .$artikels->gambar. '' ) }}"width="780" height="500"alt="blog images">
                                    </div>
                                    <div class="upcoming-date">
                                    {{ $artikels->created_at->diffForHumans() }}
                                        <span class="upc-mth"></span>
                                    </div>
                                </div>
                                <!--End Blog Thumb -->
                                    ...
                                    <div class="blog-comment-inner">
                                        ...
                                        <div class="single-blog-comment">
                                            <div class="blog-comment-thumb">
                                                <img src="{{ asset('/assets/frontend/uniqlo/images/comment/1.jpg')}}" alt="comment images">
                                            </div>
                                        ...
                                        <div class="single-blog-comment comment-reply">
                                            <div class="blog-comment-thumb">
                                                <img src="{{ asset('/assets/frontend/uniqlo/images/comment/2.jpg')}}" alt="comment images">
                                            </div>
                                            <div class="blog-comment-details">
                                                <div class="comment-title-date">
                                                    <h2><a href="#">Martin Payet</a></h2>
                                        ...
                                        <div class="single-blog-comment">
                                            <div class="blog-comment-thumb">
                                                <img src="{{ asset('/assets/frontend/uniqlo/images/comment/3.jpg')}}" alt="comment images">
                                            </div>
                                            <div class="blog-comment-details">
                                                <div class="comment-title-date">
                                                    <h2><a href="#">Martin Payet</a></h2>
...
<!-- Mirrored from demo.devitems.com/uniqlo//blogdetails by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 28 Nov 2018 04:40:50 GMT -->
</html>